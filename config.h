...
static const Rule rules[] = {
	...
	{ "Chromium","crx_nckgahadagoaajjgafhacjanaoiihapd",NULL,                   1,          0,  -1 },
...
static Key keys[] = {
	...
	{ nope,             XF86XK_AudioRaiseVolume, spawn,        {.v = volup } },
	{ nope,             XF86XK_AudioLowerVolume, spawn,        {.v = voldown } },
	{ nope,             XF86XK_AudioMute,       spawn,          {.v = volmute }  },
	{ nope,             XF86XK_AudioPlay,       spawn,         {.v = musicplay } },
	{ nope,             XF86XK_AudioNext,       spawn,         {.v = musicnext } },
	{ nope,             XF86XK_AudioPrev,       spawn,         {.v = musicprev } },
	{ nope,             XF86XK_MonBrightnessUp, spawn,        {.v = brightup } },
	{ nope,             XF86XK_MonBrightnessDown, spawn,        {.v = brightdown } },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          {.v = chromium } },
	{ MODKEY|ShiftMask,             XK_d,      spawn,          {.v = clipmenu } },
	{ nope,                         XK_Print,  spawn,          {.v = screenshot } },
