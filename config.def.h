...
static const Rule rules[] = {
	...
	{ "Pavucontrol", /* ------------------------------------------------
	---^^^^^^^^^*/NULL,       NULL,       0,            1,           -1 },
	{ NULL,       "crx_nckgahadagoaajjgafhacjanaoiihapd", /* -----------      
	---^^^^^^^^^^^^^^^^^^^^^*/NULL,       0,            1,           -1 },
	{ "TelegramDesktop", /*---------------------------------------------
	---^^^^^^^^^*/NULL,       NULL,       0,            1,           -1 },
...
static const char *dmenu_recent[] = { "dmenu_recent", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *clipmenu[] = { "clipmenu", NULL };
static const char *my_v[] = { "my_v", NULL };
static const char *volume[3][3] = {{ "volume", "up", NULL }, {"volume", "down", NULL }, {"volume", "mute", NULL }};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_v,      spawn,          {.v = my_v } },
